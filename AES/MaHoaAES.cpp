...
int main()
{
	//unsigned int Key = 0x2b7e1516 28aed2a6 abf71588 09cf4f3c ;01010101010101010101010101010101
	unsigned int w0 = 0x01010101, w1 = 0x01010101, w2 = 0x01010101, w3 = 0x01010101;
	unsigned int Key[] = {w0, w1, w2, w3};
	//input M = 3243f6a8 885a308d 313198a2 e0370734 // 000102030405060708090A0B0C0D0E0F
	unsigned int *state = new unsigned[4];
	state[0] = 0x00010203; state[1] = 0x04050607; state[2] = 0x08090A0B; state[3] = 0x0C0D0E0F;	
	//Bat dau test
